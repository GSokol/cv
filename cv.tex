...
\section* {About}
I am a backend developer with more then 10 years experience. Most of the time I
more or less dealed with \textbf{PHP}. Last 4 years I actively use \textbf{Go}.
\textbf{I have accepted pull requests in php source and big opensource projects
both on PHP and Go (like codeception, etcd etc.).} I also have experience
managing up to 5 members development teams.
...
\section* {Experience}
  ...
  \subsection* {July 2019 -- Present -- \textbf{Kurshi Games} (Backend advisor)}
    \subsubsection* {Technology \& infrostructure stack}
      GCP, GCE, GKE, Golang, PHP, Docker, Kubernetes, Redis, RabbitMQ, PostgreSQL, Kafka, Vertica, Appache Airflow
    \subsubsection* {Development \& management tools \& services}
      Git, Gitlab, Google Cloud Builds

  \subsection* {February 2019 -- May 2019 -- \textbf{Acronis} (Senior developer)}
    \subsubsection* {Technology \& infrostructure stack}
      Linux, OpenVZ, Docker, Kubernetes, Ansible, Percona, RabbitMQ, Golang, Python, Nginx
    \subsubsection* {Development \& management tools \& services}
  ...
  \subsection* {August 2015 - May 2016 -- \textbf{Delivery club LLC} (Senior developer, mobile API expert)}
    \subsubsection* {Goals \& achievements}
      \begin {list}{\textbullet}{\itemsep=0mm}
        ...
        \item provide guaranties of backward compatibility to previous API versions
